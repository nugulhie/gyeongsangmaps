...
const userInfo = firebase.auth().FirebaseUser.CurrentUser; //auth
...
// 수정한 코드
function readData(){
  var user_name = userInfo.DisplayName;
...
// 회원가입할때 이름, 이메일, 비밀번호외에 단과대학, 나이, context (프로필설명 입력) 
// 또는
// 회원가입 후 내정보 수정에서 Users 컬렉션에 uid 문서 추가
